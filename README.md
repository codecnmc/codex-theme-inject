...
- 新增并更新 12 个可导入的示例主题，覆盖动漫、影视、品牌、角色和趣味视觉风格。

## 主题预览

下列主题包均可直接下载 ZIP，并在“主题库”中导入。除特别说明外，预览图来自主题实际应用效果。
...
| [财神清爽可读](themes/财神清爽可读.zip)<br>浅色 | <img src="images/财神清爽可读.png" alt="财神清爽可读主题公开安全预览" width="360"> | 公开安全的财神工作台主题，右侧保留主视觉和财气元素，左侧与正文区域低噪留白，优先保证 Codex 文本、终端和输入区可读。 |
